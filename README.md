...
[![DOI](https://joss.theoj.org/papers/10.21105/joss.08134/status.svg)](https://doi.org/10.21105/joss.08134)
...
```sh
conda install -c conda-forge "dask>=2025.1" dask-geopandas dask-image fiona numba odc-geo pyogrio rioxarray scipy
